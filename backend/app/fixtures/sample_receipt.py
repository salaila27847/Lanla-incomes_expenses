...
One line carries a discount and the receipt has one off the whole bill, so
both discount paths are exercised too. Discounts are positive amounts here;
receipts print them negative and the normaliser strips the sign.
"""
...
SAMPLE_RECEIPT = {
    ...
    "items": [
        {"id": "1", "raw_text": "นมสดUHT250ml", "quantity": 3, "line_total": 45.0, "discount": 5.0},
